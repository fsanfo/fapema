...
## Schema: patronage | Tabela: modulos

### 1. Visao Geral (Overview)
* **Descricao Funcional:** Documentacao tecnica gerada automaticamente a partir do DDL da tabela modulos.
...
| **name** | varchar(255) | Nao |  |  | Nao informado no DDL. |
