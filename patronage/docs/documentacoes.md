...
## Schema: patronage | Tabela: documentacoes

### 1. Visao Geral (Overview)
* **Descricao Funcional:** Documentacao tecnica gerada automaticamente a partir do DDL da tabela documentacoes.
...
| **tipo** | enum('1','2') | Nao |  |  | 1 - edital, 2- chamada |
| **obrigatorio** | tinyint(1) | Nao | '0' |  | Nao informado no DDL. |
| **publico** | tinyint(1) | Nao | '0' |  | Nao informado no DDL. |
| **multiplo** | tinyint(1) | Nao | '0' |  | Nao informado no DDL. |
