...
## Schema: patronage | Tabela: roles

### 1. Visao Geral (Overview)
* **Descricao Funcional:** Documentacao tecnica gerada automaticamente a partir do DDL da tabela roles.
...
| roles_name_guard_name_unique | UNIQUE | name, guard_name | Garante unicidade dos dados indexados. |
